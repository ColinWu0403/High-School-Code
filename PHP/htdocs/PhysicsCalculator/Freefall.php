        ...
        <div class="col-12">
          <div class="tm-parallax2">
            <header class="tm-parallax-header">
              <h2 class="">Freefall Calculator</h2>
            </header>
          </div>
        </div>
      </div>
      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Freefall Calculator</h3>
          </header>
          <div class="row">
            <!-- Freefall Speed -->
            <div class="col-lg-6">
            <div class="tm-calculator-block">
              <div class="tm-calculator-block-text">
                <a rel="nofollow noopener" href="Freefall_Speed.php" class="tm-text-calculator">Freefall Speed</a>
                <p>
                  Calculates the freefall speed of an object.
                  <br>
                  Formula:
                  <br>
                  v = v₀ + gt
            ...
            <div class="col-lg-6">
              <div class="tm-calculator-block">
                <div class="tm-calculator-block-text">
                  <a rel="nofollow noopener" href="Freefall_Distance.php" class="tm-text-calculator">Freefall Distance</a>
                  <p>
                    Calculates the freefall distance of an object
                    <br>
                    Formula:
                    <br>
                    s = v₀t + (1/2)gt²
