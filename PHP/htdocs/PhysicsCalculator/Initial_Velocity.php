      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Initial Velocity Calculator</h3>
          </header>

          <form method="post">
            <label>Final Velocity:</label><br>
            <input type="text" name="fvel" placeholder="m/s" class="form-control"><br>
          ...
          ?>
            ...
            <br>
          <p>
            Back to <a rel="nofollow opener" href="Speed_Velocity.php">Speed and Velocity Calculator</a>.
          </p>
          <p>
