      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Average Acceleration Calculator</h3>
          </header>

          <form method="post">
            <label>Initial Speed:</label><br>
            <input type="text" name="ispeed" placeholder="m/s" class="form-control"><br>
            <label>Final Speed:</label><br>
            <input type="text" name="fspeed" placeholder="m/s" class="form-control"><br>
            <label>Time:</label><br>
            <input type="text" name="time" placeholder="s" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              ...
              $f = $_POST['fspeed'];
              $t = $_POST['time'];
              echo "The inital speed is: ", $i, " m/s";
              echo "<br>";
              echo "The final speed is: ", $f, " m/s";
              echo "<br>";
              echo "The time is: ", $t, " s";
              echo "<br>";
              echo "The average acceleration is: ";
              echo ($f - $i)/$t," m/s²";
            }
          ?>
          </div>
