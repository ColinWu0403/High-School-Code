      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Gravitational Acceleration Calculator</h3>
          </header>

          <form method="post">
            <label>Gravitational Constant:</label><br>
            <input type="text" name="gconst" placeholder="6.67408×10⁻¹¹ m³kg⁻¹s⁻²" class="form-control"><br>
            <label>Mass of field source:</label><br>
            <input type="text" name="mfield" placeholder="kg" class="form-control"><br>
            <label>Distance:</label><br>
            <input type="text" name="dist" placeholder="m" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              ...
              $M = $_POST['mfield'];
              $r = $_POST['dist'];
              echo "The gravitational constant is: <br> 6.67408×10⁻¹¹ m³kg⁻¹s⁻²";
              echo "<br>";
              echo "The mass of field source is: ", $M, " kg";
              echo "<br>";              
              echo "The distance is: ", $r, " m";
              echo "<br>";              
              echo "The gravitational acceleration is: ";
              echo -((0.0000000000667408*$M)/($r*$r));
              echo " m/s²";
            }
          ?>
          </div>
            ...
            <br>
          <p>
            Back to <a rel="nofollow opener" href="Acceleration.php">Acceleration Calculator</a>.
          </p>
          <p>
