        ...
        <div class="col-12">
          <div class="tm-parallax2">
            <header class="tm-parallax-header">
              <h2 class="">Distance and Displacement Calculator</h2>
            </header>
          </div>
        </div>
      </div>
      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Distance and Displacement Calculator</h3>
          </header>
          <div class="row">
            <!-- Distance -->
            <div class="col-lg-6">
            <div class="tm-calculator-block">
              <div class="tm-calculator-block-text">
                <a rel="nofollow noopener" href="Distance.php" class="tm-text-calculator">Distance</a>
                <p>
            ...
            <div class="col-lg-6">
              <div class="tm-calculator-block">
                <div class="tm-calculator-block-text">
                  <a rel="nofollow noopener" href="Displacement.php" class="tm-text-calculator">Displacement</a>
                  <p>
