        ...
        <div class="col-12">
          <div class="tm-parallax2">
            <header class="tm-parallax-header">
              <h2 class="">Speed and Velocity Calculator</h2>
            </header>
          </div>
        </div>
      </div>
      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Speed and Velocity Calculator</h3>
          </header>
          <div class="row">
            <!-- Average Velocity -->
            <div class="col-lg-6">
            <div class="tm-calculator-block">
              <div class="tm-calculator-block-text">
                <a rel="nofollow noopener" href="Average_Velocity.php" class="tm-text-calculator">Avrg Velocity</a>
                <p>
                  Calculates the average velocity/speed of an object
                  <br>
                  Formula:
                  <br>
                  s = d/t
            ...
            <div class="col-lg-6">
              <div class="tm-calculator-block">
                <div class="tm-calculator-block-text">
                  <a rel="nofollow noopener" href="Initial_Velocity.php" class="tm-text-calculator">Init Velocity</a>
                  <p>
                    Calculates the initial velocity/speed of an object
                    <br>
                    Formula:
                    <br>
                    u = v−at
