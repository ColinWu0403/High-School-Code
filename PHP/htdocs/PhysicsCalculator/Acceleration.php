        ...
        <div class="col-12">
          <div class="tm-parallax2">
            <header class="tm-parallax-header">
              <h2 class="">Acceleration Calculator</h2>
            </header>
          </div>
        </div>
      </div>
      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Acceleration Calculator</h3>
          </header>
          <div class="row">
            ...
            <div class="tm-calculator-block">
              <div class="tm-calculator-block-text">
                <a rel="nofollow noopener" href="Average_Acceleration.php" class="tm-text-calculator">Average Acceleration</a>
                <p>
                  Calculates the average accceleration of an object
                  <br>
                  Formula:
                  <br>
                  A = Δv / Δt
            ...
            <div class="col-lg-6">
              <div class="tm-calculator-block">
                <div class="tm-calculator-block-text">
                  <a rel="nofollow noopener" href="Gravitational_Acceleration.php" class="tm-text-calculator">Gravitational Acceleration</a>
                  <p>
                    Calculates the gravitational acceleration of an object
                    <br>
                    Formula:
                    <br>
                    g = - (GM / r^2)
