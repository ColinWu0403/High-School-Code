      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Displacement Calculator</h3>
          </header>

          <form method="post">
            <label>Initial Velocity:</label><br>
            <input type="text" name="ivel" placeholder="m/s" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              ...
              $a = $_POST['accel'];
              $t = $_POST['time'];
              echo "The inital velocity is: ", $u, " m/s";
              echo "<br>";
              echo "The acceleration is: ", $a, " m/s²";
              echo "<br>";
              echo "The time is: ", $t, " s";
              echo "<br>";
              echo "The displacement is is: ";
              echo ($u*$t) + 1/2*$a*($t*$t);
              echo " m";
            }
          ?>
            ...
            <br>
          <p>
            Back to <a rel="nofollow opener" href="Distance_Displacement.php">Distance and Displacement Calculator</a>.
          </p>
          <p>
