      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Density Calculator</h3>
          </header>

          <form method="post">
            <label>Mass:</label><br>
            <input type="text" name="mass" placeholder="kg" class="form-control"><br>
            <label>Volume:</label><br>
            <input type="text" name="volume" placeholder="m³" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              $m = $_POST['mass'];
              $v = $_POST['volume'];
              echo "The mass is: ", $m, "kg";
              echo "<br>";
              echo "The volume is: ", $v, " m³";
              echo "<br>";
              echo "The density is: ";
              echo $m/$v;
              echo " kg/m³";
