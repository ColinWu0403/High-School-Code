      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Pressure Calculator</h3>
          </header>

          <form method="post">
            <label>Force:</label><br>
            <input type="text" name="force" placeholder="N" class="form-control"><br>
            <label>Area:</label><br>
            <input type="text" name="area" placeholder="m²" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              $N = $_POST['force'];
              $a = $_POST['area'];
              echo "The force is: ", $N, " N";
              echo "<br>";
              echo "The area is: ", $a, " m²";
              echo "<br>";
              echo "The density is: ";
              echo $N/$a;
              echo " pascals";
