      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Buoyant Force Calculator</h3>
          </header>

          <form method="post">
            <label>Fluid Density:</label><br>
            <input type="text" name="density" placeholder="kg/m³" class="form-control"><br>
            <label>Gravitational Acceleration:</label><br>
            <input type="text" name="accel" placeholder="m/s²" class="form-control"><br>
            <label>Fluid Volume:</label><br>
            <input type="text" name="vol" placeholder="m³" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              ...
              $g = $_POST['accel'];
              $V = $_POST['vol'];
              echo "The density of the fluid is: ", $p, " kg/m³";
              echo "<br>";
              echo "The gravitational acceleration is: ", $g, " m/s²";
              echo "<br>";
              echo "The volume of the fluid is: ", $V, " m³";
              echo "<br>";
              echo "The buoyant force is: ";
              echo $p*$g*$V;
              echo " N";
            }
          ?>
