      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Average Velocity Calculator</h3>
          </header>

          <form method="post">
            <label>Distance:</label><br>
            <input type="text" name="distance" placeholder="m" class="form-control"><br>
            <label>Time:</label><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              $d = $_POST['distance'];
              $t = $_POST['time'];
              echo "The distance is: ", $d, " m";
              echo "<br>";
              echo "The time is: ", $t, " s";
              echo "<br>";
              echo "The average velocity is: ";
              echo $d / $t, " m/s";
