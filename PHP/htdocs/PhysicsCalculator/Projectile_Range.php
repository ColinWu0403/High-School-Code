      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Projectile Range Calculator</h3>
          </header>

          <form method="post">
            <label>Vertical Velocity:</label><br>
            <input type="text" name="vvel" placeholder="m/s" class="form-control"><br>
            <label>Horizontal Velocity:</label><br>
            <input type="text" name="hvel" placeholder="m/s" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              ...
              echo "<br>";
              echo "The horizontal velocity is: ", $Vx, " m/s";
              echo "<br>";
