      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Time Calculator</h3>
          </header>
          <div class="row">
            <!-- Time -->
            <div class="col-lg-6">
            <div class="tm-calculator-block">
              <div class="tm-calculator-block-text">
                <a rel="nofollow noopener" href="Time.php" class="tm-text-calculator">Time</a>
                <p>
                  Calculates the time an object takes to reach a certain distance
                  <br>
                  Formula:
                  <br>
                  t = d/s
            ...
            <div class="col-lg-6">
              <div class="tm-calculator-block">
                <div class="tm-calculator-block-text">
                  <a rel="nofollow noopener" href="Elapsed_Time.php" class="tm-text-calculator">Elapsed Time</a>
                  <p>
                    Calculates the elapsed time of an object
                    <br>
                    Formula:
                    <br>
                    Δt = tf − t0
