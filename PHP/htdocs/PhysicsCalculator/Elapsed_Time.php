      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Elapsed Time Calculator</h3>
          </header>

          <form method="post">
            <label>Final Time:</label><br>
            <input type="text" name="ftime" placeholder="s" class="form-control"><br>
            <label>Initial Time:</label><br>
            <input type="text" name="itime" placeholder="s" class="form-control"><br>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              $f = $_POST['ftime'];
              $i = $_POST['itime'];
              echo "The final time is: ", $f, " s";
              echo "<br>";
              echo "The initial time is: ", $i, " s";
              echo "<br>";
          ...
          ?>
            ...
            <br>
          <p>
            Back to <a rel="nofollow opener" href="Time_Page.php">Time Calculator</a>.
          </p>
          <p>
