      ...
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">Freefall Distance Calculator</h3>
          </header>
          ...
          <?php
            if(isset($_POST['calculate'])) {
              ...
              $g = $_POST['accel'];
              $t = $_POST['time'];
              echo "The inital velocity is: ", $v, " m/s";
              echo "<br>";
              echo "The acceleration is: ", $g, " m/s²";
              echo "<br>";
              echo "The time is: ", $t, " s";
              echo "<br>";
              echo "The freefall distance is is: ";
              echo $v + (1/2)*$g*($t*$t);
              echo " m";
            }
          ?>
            ...
            <br>
          <p>
            Back to <a rel="nofollow opener" href="Freefall.php">Freefall Calculator</a>.
          </p>
          <p>
